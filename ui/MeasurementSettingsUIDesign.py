...
class Ui_MeasurementSettingsWidgetDesign(object):
    def setupUi(self, MeasurementSettingsWidgetDesign):
        MeasurementSettingsWidgetDesign.setObjectName("MeasurementSettingsWidgetDesign")
        MeasurementSettingsWidgetDesign.resize(300, 155)
        self.groupBox = QtWidgets.QGroupBox(MeasurementSettingsWidgetDesign)
        ...
        self.gridLayout.addWidget(self.position_label, 1, 0, 2, 1)
        ...
        self.gridLayout.addWidget(self.start_timeEdit, 2, 1, 2, 1)
        ...
        self.type_comboBox.addItem("")
        self.gridLayout.addWidget(self.type_comboBox, 4, 1, 1, 1)

        self.retranslateUi(MeasurementSettingsWidgetDesign)
        QtCore.QMetaObject.connectSlotsByName(MeasurementSettingsWidgetDesign)
